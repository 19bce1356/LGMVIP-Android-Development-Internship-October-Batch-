...
public class StateListAdapter extends RecyclerView.Adapter<StateListAdapter.MyViewHolder> implements Filterable {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            this.state_nameTv=view.findViewById(R.id.state_nameTv);
            this.confirm_casesTv=view.findViewById(R.id.confirm_cases);
            this.counterTv=view.findViewById(R.id.counter);
            this.state_cardView=view.findViewById(R.id.state_card_view);
        }
    }
